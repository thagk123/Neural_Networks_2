...
for C in C_values:
    for gamma in gammas:
        for degree in degrees:
            i+=1
            print(f"\n Συνδυασμός {i}, Εκπαίδευση SVM με πυρήνα Polynomial, C={C}, gamma={gamma} και degree={degree}")
            ...
            print(
                f"Πυρήνας: Polynomial, C={C}, gamma={gamma} και degree={degree}, "f"Ακρίβεια στο Training set: {train_accuracy:.2f}%, "f"Ακρίβεια στο Test set: {test_accuracy:.2f}%, "f"Χρόνος Εκπαίδευσης: {train_time/60:.2f} λεπτά, "f"Χρόνος Προβλέψεων: {pred_time/60:.2f} λεπτά")
